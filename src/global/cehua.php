...
<!-- 此处为侧滑的html代码 -->
	...
	<text class="mdui-list-item cehua_top_text mdui-color-theme-accent mdui-typo-subheading">&nbsp;晓空-Rapi</text>
	
    <!-- 主页按钮 -->
    <div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
        <i class="mdui-list-item-icon mdui-icon material-icons">home</i>
        <a href="./index.php" class="mdui-list-item mdui-ripple mdui-color-transparent mdui-text-color-black-text mdui-col-xs-12 mdui-typo-subheading">&nbsp;&nbsp;&nbsp;主页</a>
    </div>
	<!-- 分割线 -->
